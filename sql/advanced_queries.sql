...
-- Repository: LuxuryBrand-Clientele-Retention-Omnichannel-LTV
...
WITH daily_aggregates AS (
    SELECT
        ...
        AVG(f.purchase_amount) AS avg_metric_val,
        AVG(f.annual_clv_score) AS avg_target_val,
        SUM(f.anomaly_flag) AS total_anomalies
    FROM fact_luxury_purchase f
